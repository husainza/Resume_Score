...
2. **Configure API Key**: Open `app.js` and replace `YOUR_OPENAI_API_KEY_HERE` with your actual OpenAI API key
...
### 1. Setup
1. **Configure API Key**: Open `app.js` and replace `YOUR_OPENAI_API_KEY_HERE` with your actual OpenAI API key
...
- Check that you've replaced `YOUR_OPENAI_API_KEY_HERE` with your actual API key in `app.js`
